...
(defun endpoint-of-type (name type schema arguments new-concat-list &key (documentation nil documentation-p))
...
(defun endpoint-definition (name accepted-methods schema endpoint &key (documentation nil))
  ...
  (let ((arguments
    ...
    (let ((endpoints nil))
      (loop :for method in accepted-methods :do
           (push (endpoint-of-type name method schema arguments new-concat-list :documentation documentation)
                 endpoints))
          endpoints)))
