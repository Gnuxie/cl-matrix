...
(defun get-login (authentication &key parameters)
  ...
  (handle-json-only-request
   (lambda ()
     (get-request (concatenate 'string "/_matrix/client/r0/" "login")
                  authentication :parameters (check-parameters parameters)))))
...
(defun post-login
  ...
  (handle-json-only-request
   (lambda ()
     (post-request (concatenate 'string "/_matrix/client/r0/" "login")
                   authentication content :parameters
                   (check-parameters parameters) :content-type content-type))))
...
(defun post-logout
  ...
  (handle-json-only-request
   (lambda ()
     (post-request (concatenate 'string "/_matrix/client/r0/" "logout")
                   authentication content :parameters
                   (check-parameters parameters) :content-type content-type))))
  ...
  (handle-json-only-request
   (lambda ()
     (post-request
      ...
      authentication content :parameters (check-parameters parameters)
...
(defun post-register
  ...
  (handle-json-only-request
   (lambda ()
     (post-request (concatenate 'string "/_matrix/client/r0/" "register")
                   authentication content :parameters
                   (check-parameters parameters) :content-type content-type))))
...
(defun get-sync (authentication &key parameters)
  ...
  (handle-json-only-request
   (lambda ()
     (get-request (concatenate 'string "/_matrix/client/r0/" "sync")
                  authentication :parameters (check-parameters parameters)))))
...
(defun get-events (authentication &key parameters)
  ...
  (handle-json-only-request
   (lambda ()
     (get-request (concatenate 'string "/_matrix/client/r0/" "events")
                  authentication :parameters (check-parameters parameters)))))
...
(defun get-initialsync (authentication &key parameters)
  ...
  (handle-json-only-request
   (lambda ()
     (get-request (concatenate 'string "/_matrix/client/r0/" "initialSync")
                  authentication :parameters (check-parameters parameters)))))
...
(defun post-createroom
  ...
  (handle-json-only-request
   (lambda ()
     (post-request (concatenate 'string "/_matrix/client/r0/" "createRoom")
                   authentication content :parameters
                   (check-parameters parameters) :content-type content-type))))
...
(defun get-joined-rooms (authentication &key parameters)
  ...
  (handle-json-only-request
   (lambda ()
     (get-request (concatenate 'string "/_matrix/client/r0/" "joined_rooms")
                  authentication :parameters (check-parameters parameters)))))
...
(defun get-publicrooms (authentication &key parameters)
  ...
  (handle-json-only-request
   (lambda ()
     (get-request (concatenate 'string "/_matrix/client/r0/" "publicRooms")
                  authentication :parameters (check-parameters parameters)))))
...
(defun post-publicrooms
  ...
  (handle-json-only-request
   (lambda ()
     (post-request (concatenate 'string "/_matrix/client/r0/" "publicRooms")
                   authentication content :parameters
                   (check-parameters parameters) :content-type content-type))))
...
(defun post-upload
  ...
  (handle-http-request
   (lambda ()
     (post-request (concatenate 'string "/_matrix/media/r0/" "upload")
                   authentication content :parameters
                   (check-parameters parameters) :content-type content-type))))
...
(defun get-preview-url (authentication &key parameters)
  ...
  (handle-http-request
   (lambda ()
     (get-request (concatenate 'string "/_matrix/media/r0/" "preview_url")
                  authentication :parameters (check-parameters parameters)))))
...
(defun get-config (authentication &key parameters)
  ...
  (handle-http-request
   (lambda ()
     (get-request (concatenate 'string "/_matrix/media/r0/" "config")
                  authentication :parameters (check-parameters parameters)))))
...
(defun get-devices (authentication &key parameters)
  ...
  (handle-json-only-request
   (lambda ()
     (get-request (concatenate 'string "/_matrix/client/r0/" "devices")
                  authentication :parameters (check-parameters parameters)))))
...
(defun post-delete-devices
  ...
  (handle-json-only-request
   (lambda ()
     (post-request (concatenate 'string "/_matrix/client/r0/" "delete_devices")
                   authentication content :parameters
                   (check-parameters parameters) :content-type content-type))))
...
(defun get-pushers (authentication &key parameters)
  ...
  (handle-json-only-request
   (lambda ()
     (get-request (concatenate 'string "/_matrix/client/r0/" "pushers")
                  authentication :parameters (check-parameters parameters)))))
...
(defun get-notifications (authentication &key parameters)
  ...
  (handle-json-only-request
   (lambda ()
     (get-request (concatenate 'string "/_matrix/client/r0/" "notifications")
                  authentication :parameters (check-parameters parameters)))))
...
(defun get-pushrules/ (authentication &key parameters)
  ...
  (handle-json-only-request
   (lambda ()
     (get-request (concatenate 'string "/_matrix/client/r0/" "pushrules")
                  authentication :parameters (check-parameters parameters)))))
...
(defun post-search
  ...
  (handle-json-only-request
   (lambda ()
     (post-request (concatenate 'string "/_matrix/client/r0/" "search")
                   authentication content :parameters
                   (check-parameters parameters) :content-type content-type))))
